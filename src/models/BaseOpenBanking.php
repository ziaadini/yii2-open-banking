    ...
    public static function itemAlias($type, $code = NULL, $params = null)
    {
        $_items = [
            ...
            'ServiceTypeMap' => [
                ...
                self::IRANIAN_GET_TOKEN => 'token',
                self::IRANIAN_REFRESH_TOKEN => 'token',
                self::IRANIAN_REQUEST => 'request',
                self::IRANIAN_RE_NEW_TOKEN => 'renewToken',
            ...
            'ServiceUrl' => [
                ...
                self::IRANIAN_RE_NEW_TOKEN => [self::IRANIAN_BASE_URL . '/request/' . ($params['hash_code'] ?? '') . '/renewToken'],
